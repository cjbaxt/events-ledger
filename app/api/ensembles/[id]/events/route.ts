...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const [classicalRes, operaRes, balletRes, danceRes, circusRes, cabaretRes, comedyRes, musicRes, musicSupportRes, theatreRes, creditRes] = await Promise.all([
  ...
  for (const res of [classicalRes, operaRes, balletRes, danceRes, circusRes, cabaretRes, comedyRes, musicRes, musicSupportRes, theatreRes, creditRes]) {
