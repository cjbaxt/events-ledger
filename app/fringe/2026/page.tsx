...
const SENTIMENT = {
  ...
  themes: [
    { label: "Queerness", desc: "Ran through closer to a dozen shows — Bi-Curious George's snail and its gender identity, FUCCBOIS, both Heated Rivalry parodies, Tell Me's AIDS story without words, Bernie Dieter's and Kaye Hole as queer variety spectacle, ALOK, Sofie Hagen, and the drag throughout. You didn't seek it out consciously; it appeared because you kept choosing the shows where it lives." },
...
const FIVE_STAR_EXCERPTS: Record<string, string> = {
  ...
  "The Kaye Hole Hosted by Reuben Kaye": "Rosie Jones had us all cackling when her microphone didn't work: 'Even my microphone is disabled.' You could see Reuben literally double over at the side of the stage. Later: the spellbindingly beautiful shaving performance from ex-Cirque du Soleil acrobat and ex-professional ballet dancer David Pereira — the lines of his body and eye contact while lip syncing and shaving were fascinating to watch.",
