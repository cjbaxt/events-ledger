...
const SENTIMENT = {
  ...
  themes: [
    { label: "Queerness", desc: "Ran through closer to a dozen shows — Bi-Curious George's snail and its gender identity, FUCCBOIS, both Heated Rivalry parodies, Tell Me's AIDS story without words, Bernie Dieter's and Kaye Hole as queer variety spectacle, ALOK, Sofie Hagen, and the drag throughout. A recurring thread at every rating level and across every genre." },
